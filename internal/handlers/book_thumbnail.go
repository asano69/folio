...
// BookThumbnailHandler serves GET /thumbnails/{bookID}.
...
type BookThumbnailHandler struct {
	Store *store.Store
}

func (h *BookThumbnailHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
